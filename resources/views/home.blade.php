...
<body class="font-main">
    ...
    <div class="w-full h-screen bg-no-repeat bg-cover bg-center" style="background-image: url('/images/home-background.png');">
        <div class="pt-8 px-20 flex  justify-between">
            ...
            <div class="text-white flex w-1/3">
                ...
                <div class="flex justify-evenly w-1/2">
                    <a class="px-4 py-1 border border-main-colour rounded-full" href="#">
                        Log In
                    </a>
                    <a class="px-4 py-1 bg-main-colour rounded-full" href="#">
                        Sign Up
                    </a>
                </div>
            </div>
